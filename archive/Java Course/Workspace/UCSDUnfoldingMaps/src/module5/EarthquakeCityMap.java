...
public class EarthquakeCityMap extends PApplet {
	...
	private void selectMarkerIfHover(List<Marker> markers)
	{
		for(int i=0; i<markers.size(); i++) {
			...
			if(currentMarker.isInside(map, mouseX, mouseY)) {
...
//				lastClicked.
//				Location cityLocation = cityMarkers.get(i).getLocation();
//				if(cityMarkers.get(i).isInside(map, )) {
//					cityMarkers.get(i).setHidden(false);
//				} else {
//					cityMarkers.get(i).setHidden(true);
//				}
			}
		}
